...
var FamousView = marionette.View.extend({
    ...
    invalidate: function(){
        this._render();
        this.trigger('famous:render', this);
    },
    ...
    createRenderNode: function(){
        ...
        if(!this.renderable && this.shouldInitializeRenderable()){
            this.renderable = this.initializeRenderable();
        }

        if(this.template){
            // a rich.View will not need a template, it's
            // just a container. `initialize` on the view
            // will be called here.
    ...
    addSubview: function(view, zIndex){
        ...
        this.listenTo(view, 'famous:render', this.subviewDidChange);
    ...
    removeSubview: function(view){
        ...
        this.stopListening(view, 'famous:render', this.subviewDidChange);
    ...
    getSize: function(){
        ...
        // if (this.root && this.root.getSize) {
        //     return this.root.getSize.apply(this.root, arguments) || this.options.size;
        // }
    ...
    renderTemplate: function(context){
        // TODO: FIX THIS HACK!
        // WE FORCE TEMPLATES TO ONLY RENDER ONCE IN THE
        // CHEAPEST WAY POSSIBLE FOR DEV PURPOSES
        if(this.test) return;
        this.test = true;

        // finalize the backbone.View initialization
    ...
    _ensureElement: function(renderable, context) {
      if (!this.el) {
        ...
        renderable.commit(context._nodeContext);
